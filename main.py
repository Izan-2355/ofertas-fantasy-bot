...
async def create_offer(interaction: discord.Interaction, target_member: discord.Member):
 ...
 # Obtener posiciones de las categorias Fantasy y Modo Carreras
 ...
 # Calcular la posicion: entre Fantasy y Modo Carreras
 ...
 position = None # Dejar en la posicion por defecto
 
 # Crear categoria con posicion especificada
